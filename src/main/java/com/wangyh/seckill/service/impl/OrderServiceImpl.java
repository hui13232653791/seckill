...
import com.wangyh.seckill.mapper.OrderMapper;
...
import com.wangyh.seckill.service.ISeckillGoodsService;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements IOrderService {
    ...
    public Boolean checkCaptcha(User user, Long goodsId, String captcha) {
        ...
        String redisCaptha = (String) redisTemplate.opsForValue().get("captcha:" + user.getId() + ":" + goodsId);
        return captcha.equals(redisCaptha);
    }
}
